...
export const Header = () => {
  return (
  <header className="flex flex-wrap sm:justify-start sm:flex-nowrap w-full text-sm py-3 sticky top-0 z-10 backdrop-blur">
    <nav className="max-w-[85rem] w-full mx-auto px-4 flex flex-wrap basis-full items-center ">
    <a className="font-semibold tracking-tighter text-gray-900 dark:text-white text-3xl"><span className="tracking-tighter text-transparent bg-clip-text bg-gradient-to-r to-violet-950 from-violet-500 text-3xl ">Stash</span>Pal</a>
      ...
      <div id="hs-navbar-alignment" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:grow-0 sm:basis-auto sm:block sm:order-2" aria-labelledby="hs-navbar-alignment-collapse">
        <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:mt-0 sm:ps-5">
          <Link className="font-medium text-violet-950 hover:text-gray-400 focus:outline-none focus:text-gray-400" href="/">Landing</Link>
          <Link className="font-medium text-violet-950 hover:text-gray-400 focus:outline-none focus:text-gray-400" href="/pantry">Your Pantry</Link>
          </div>
      </div>
    </nav>
</header>
